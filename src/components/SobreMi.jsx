...
export const SobreMi = () => {
    return (
        <div>
            ...
            <div className='flex justify-center pt-4'>
                <a href='https://drive.google.com/file/d/1Z8fFfUQWezDEMm3NUgoTcbrT4bbS5Zy5/view?usp=share_link' target="_blank" rel="noopener noreferrer"><button className='bg-blue-800 w-auto rounded-md p-2 font-bold hover:scale-125 transform transition-transform duration-500'>Ver mi CV</button></a>
            </div>
            </div>
        </div>
    )
