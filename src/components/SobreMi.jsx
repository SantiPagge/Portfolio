...
export const SobreMi = () => {
    ...
    return (
        <div>
            ...
            <div className='flex justify-center pt-4'>
                <a href='https://drive.google.com/file/d/1i1u5W2k7L5X2-igugT8tb19meLgyXbn_/view?usp=sharing' target="_blank" rel="noopener noreferrer"><button className='bg-blue-800 w-auto rounded-md p-2 font-bold hover:scale-125 transform transition-transform duration-500'>{idioma === 'español' ? 'Ver mi CV' : 'See my CV'}</button></a>
            </div>
            </div>
        </div>
    )
